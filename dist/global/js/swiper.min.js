...
!function (e, t) {
    ...
    on: function on() {
      function t(t) {
        ...
        if (a) {
          ...
          if (i.unshift(t), e(a).is(o)) l.apply(a, i);else for (var s = e(a).parents(), r = 0; r < s.length; r += 1) {
      ...
      for (var c, u = n.split(" "), h = 0; h < this.length; h += 1) {
        ...
        if (o) for (c = 0; c < u.length; c += 1) {
          v.dom7LiveListeners || (v.dom7LiveListeners = []), v.dom7LiveListeners.push({
            type: n,
            listener: l,
            proxyListener: t
          }), v.addEventListener(u[c], t, d);
        } else for (c = 0; c < u.length; c += 1) {
          v.dom7Listeners || (v.dom7Listeners = []), v.dom7Listeners.push({
            type: n,
            listener: l,
            proxyListener: a
  ...
  var h = {
    ...
    images: {
      loadImage: function loadImage(e, t, a, i, r, n) {
        function o() {
          n && n();
        }
      ...
      Object.keys(c.modules).forEach(function (e) {
        ...
        if (t.params) {
          var a = Object.keys(t.params)[0],
              i = t.params[a];
          if ("object" != _typeof(i)) return;
          if (!(a in o && "enabled" in i)) return;
          !0 === o[a] && (o[a] = {
            enabled: !0
          }), "object" != _typeof(o[a]) || "enabled" in o[a] || (o[a].enabled = !0), o[a] || (o[a] = {
            enabled: !1
          });
        }
      });
    ...
    update: function update(e) {
      ...
      var T = [],
          E = [];
      if (e) a.$wrapperEl.find("." + a.params.slideClass).remove();else for (var S = d; S <= p; S += 1) {
    ...
    on: {
      ...
      U = {
    setTransform: function setTransform(t, a) {
      var i = this,
          s = i.rtl,
          r = e(t),
          n = s ? -1 : 1,
    ...
    on: {
      ...
      J = {
    loadInSlide: function loadInSlide(t, a) {
      void 0 === a && (a = !0);
      var i = this,
          s = i.params.lazy;
